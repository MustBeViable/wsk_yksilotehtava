...
export const restaurantMenuUrl = 'https://media2.edu.metropolia.fi/restaurant/api/v1/restaurants/daily/'

//caches restauranlist to only one API call per reload.
let restaurantsCache = [];

export function getRestaurantsCache() { return restaurantsCache; }
export function setRestaurantsCache(restauranlist) { restaurantsCache = restauranlist; }
